        ...
        <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
          ...
          <div>
            <section className="mb-4">
              ...
              <Link
                className="btn btn-primary btn-floating m-1"
                style={{ backgroundColor: "#ac2bac", borderRadius: "25px" }}
                to="/"
                role="button"
              >
...
<Link to="#" className="fa fa-android"></Link>
<Link to="#" className="fa fa-dribbble"></Link>
<Link to="#" className="fa fa-vimeo"></Link>
<Link to="#" className="fa fa-tumblr"></Link>
<Link to="#" className="fa fa-vine"></Link>
<Link to="#" className="fa fa-foursquare"></Link>
<Link to="#" className="fa fa-stumbleupon"></Link>
<Link to="#" className="fa fa-flickr"></Link>
<Link to="#" className="fa fa-yahoo"></Link>
<Link to="#" className="fa fa-reddit"></Link>
<Link to="#" className="fa fa-rss"></Link>
