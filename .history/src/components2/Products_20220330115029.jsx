    ...
    return (
      <>
        <div className="buttons d-flex flex justify-content-center mb-5 pb-5">
          ...
          <button className="btn btn-outline-dark me-2"onClick={()=>filterProduct("men's clothing")}>Mens,s Clothes</button>
          ...
          return (
            <>
              ...
              .    ${product.price}
                    ...
                    <Link to={`/poducts/${product.id}`} className="btn btn-outline-dark">
                      Buy now
                    </Link>
                  </div>
                </div>
